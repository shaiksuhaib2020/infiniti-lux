  ...
  return (
    <div className={styles.splitLeftWrapper}>
      ...
      <div className={styles.methodsList}>
        ...
        <a href={mapsLink} target="_blank" rel="noopener noreferrer" className={styles.methodRow}>
          <MapPin className={styles.methodIcon} size={20} />
          <div className={styles.methodContent}>
            <div className={styles.methodLabel}>Location</div>
            <div className={styles.methodDetail}>Al Zarooni Building, Burjuman, Dubai, UAE</div>
          </div>
        </a>
      </div>
      ...
      <div className={styles.socialBlock}>
        ...
        <div className={styles.socialRow}>
          <a href="https://www.instagram.com/infinitiluxetravels?stkn=YnY4b2U4YTE1OTZ1&utm_source=qr" className={styles.socialIcon} target="_blank" rel="noopener noreferrer" title="Instagram">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
          </a>
          <a href="https://www.facebook.com/infinitiluxetravels" className={styles.socialIcon} target="_blank" rel="noopener noreferrer" title="Facebook">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
          </a>
          <a href="https://www.linkedin.com/in/infiniti-luxe-travel-tourism-099a33436" className={styles.socialIcon} target="_blank" rel="noopener noreferrer" title="LinkedIn">
